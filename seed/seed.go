...
func main() {
	...
	training_groups = append(training_groups, model.TrainingGroup{ID: 1, Name: "筋トレグループ"})
	training_groups = append(training_groups, model.TrainingGroup{ID: 2, Name: "みんなで筋トレ"})
